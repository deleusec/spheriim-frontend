...
function CareerContent(props: { logo: string; title: string; job: string; dateStart: string; dateEnd?: string; description?: string; }) {
    const { logo, title, job, dateStart, dateEnd, description } = props;
