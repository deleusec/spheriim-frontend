function StudentInfo(props: { firstname: string; name: string; mail: string; axe: string; grade: string; startYear: string; jobPosition: string; job: string; company: string; }) {
    const { firstname, name, mail, axe, grade, startYear, jobPosition, job, company } = props;
