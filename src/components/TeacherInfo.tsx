...
function TeacherInfo(props: { profilePic?: string; firstname: string; name: string; mail: string; speciality: string;}) {
    ...
    return (
        <section className="w-full flex justify-center items-center gap-12 p-6 bg-white">
            ...
            <Image src={ profilePicDisplay } alt="Photo du professeur" width={500} height={500}/></div>
            <div>
                ...
                <ul className="gap-4">
                    ...
                    <li className="mb-2"><span className="text-primary font-medium">Spécialité : </span> {speciality}</li>
                </ul>
            </div>        
        </section>
    );
